...
public class TinyLog extends AbstractLog {
	...
	@Override
	public boolean isEnabled(com.tools.log.level.Level level) {
	...
	/**
	 * 将tools的Level等级转换为Tinylog的Level等级
	 *
	 * @param level tools的Level等级
	 * @return Tinylog的Level
	 * @since 4.0.3
	 */
	private Level toTinyLevel(com.tools.log.level.Level level) {
		Level tinyLevel;
		switch (level) {
		case TRACE:
