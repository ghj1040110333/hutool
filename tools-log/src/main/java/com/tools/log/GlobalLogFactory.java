...
public class GlobalLogFactory {
	 ...
	 * 自定义日志实现
	 *
	 * @see com.tools.log.dialect.slf4j.Slf4jLogFactory
	 * @see Log4jLogFactory
	 * @see com.tools.log.dialect.log4j2.Log4j2LogFactory
	 * @see com.tools.log.dialect.commons.ApacheCommonsLogFactory
	 * @see JdkLogFactory
	 * @see com.tools.log.dialect.console.ConsoleLogFactory
	 *
