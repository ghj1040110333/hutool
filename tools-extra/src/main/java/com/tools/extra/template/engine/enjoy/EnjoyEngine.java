package com.tools.extra.template.engine.enjoy;
...
public class EnjoyEngine implements TemplateEngine {
	...
	private static com.jfinal.template.Engine createEngine(TemplateConfig config) {
		final com.jfinal.template.Engine engine = com.jfinal.template.Engine.create("tools-Enjoy-Engine-" + IdUtil.fastSimpleUUID());
