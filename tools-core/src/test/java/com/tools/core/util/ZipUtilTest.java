...
public class ZipUtilTest {
	...
	public void unzipFromStreamTest() {
		File unzip = ZipUtil.unzip(FileUtil.getInputStream("e:/test/tools-core-5.1.0.jar"), FileUtil.file("e:/test/"), CharsetUtil.CHARSET_UTF_8);
		Console.log(unzip);
	}
	...
	public void zipStreamTest(){
		//https://github.com/looly/tools/issues/944
		String dir = "d:/test";
