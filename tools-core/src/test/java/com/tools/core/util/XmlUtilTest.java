...
import com.tools.core.map.MapBuilder;
...
public class XmlUtilTest {
	...
	public void cleanCommentTest() {
		final String xmlContent = "<info><title>tools</title><!-- 这是注释 --><lang>java</lang></info>";
		final String ret = XmlUtil.cleanComment(xmlContent);
		Assert.assertEquals("<info><title>tools</title><lang>java</lang></info>", ret);
	}
