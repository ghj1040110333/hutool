...
public class URLUtilTest {
	...
	public void normalizeTest() {
		String url = "http://www.tools.cn//aaa/bbb";
		String normalize = URLUtil.normalize(url);
		Assert.assertEquals("http://www.tools.cn/aaa/bbb", normalize);

		url = "www.tools.cn//aaa/bbb";
	...
	public void normalizeTest2() {
		String url = "http://www.tools.cn//aaa/\\bbb?a=1&b=2";
		String normalize = URLUtil.normalize(url);
		Assert.assertEquals("http://www.tools.cn/aaa/bbb?a=1&b=2", normalize);

		url = "www.tools.cn//aaa/bbb?a=1&b=2";
		normalize = URLUtil.normalize(url);
		Assert.assertEquals("http://www.tools.cn/aaa/bbb?a=1&b=2", normalize);
	}
	...
	public void formatTest() {
		String url = "//www.tools.cn//aaa/\\bbb?a=1&b=2";
		String normalize = URLUtil.normalize(url);
		Assert.assertEquals("http://www.tools.cn/aaa/bbb?a=1&b=2", normalize);
	}
	...
	public void getHostTest() throws MalformedURLException {
		String url = "https://www.tools.cn//aaa/\\bbb?a=1&b=2";
		String normalize = URLUtil.normalize(url);
		URI host = URLUtil.getHost(new URL(normalize));
		Assert.assertEquals("https://www.tools.cn", host.toString());
	}
