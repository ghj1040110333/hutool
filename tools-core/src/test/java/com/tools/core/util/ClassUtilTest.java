...
public class ClassUtilTest {
	...
	public void getClassNameTest() {
		...
		Assert.assertEquals("com.tools.core.util.ClassUtil", className);
	...
	public void getShortClassNameTest() {
		String className = "com.tools.core.util.StrUtil";
		String result = ClassUtil.getShortClassName(className);
		Assert.assertEquals("c.t.c.u.StrUtil", result);
	}

	@Test
	public void getLocationPathTest(){
		final String classDir = ClassUtil.getLocationPath(ClassUtilTest.class);
		Assert.assertTrue(Objects.requireNonNull(classDir).endsWith("/tools-core/target/test-classes/"));
	}
}
