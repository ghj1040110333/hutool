...
import com.tools.core.net.url.UrlBuilder;
...
public class UrlBuilderTest {
	...
	public void buildTest() {
		String buildUrl = UrlBuilder.create().setHost("www.tools.cn").build();
		Assert.assertEquals("http://www.tools.cn/", buildUrl);
	}
	...
	public void testHost() {
		String buildUrl = UrlBuilder.create()
				.setScheme("https")
				.setHost("www.tools.cn").build();
		Assert.assertEquals("https://www.tools.cn/", buildUrl);
	}
	...
	public void testHostPort() {
		String buildUrl = UrlBuilder.create()
				.setScheme("https")
				.setHost("www.tools.cn")
				.setPort(8080)
				.build();
		Assert.assertEquals("https://www.tools.cn:8080/", buildUrl);
	}
	...
	public void testPathAndQuery() {
		...
		Assert.assertEquals("https://www.tools.cn/aaa/bbb?ie=UTF-8&wd=test", buildUrl);
	}
	...
	public void testQueryWithChinese() {
		...
		Assert.assertEquals("https://www.tools.cn/aaa/bbb?ie=UTF-8&wd=%E6%B5%8B%E8%AF%95", buildUrl);
	}
	...
	public void testMultiQueryWithChinese() {
		...
		Assert.assertEquals("https://www.tools.cn/s?ie=UTF-8&ie=GBK&wd=%E6%B5%8B%E8%AF%95", buildUrl);
	}
	...
	public void testFragment() {
		...
		Assert.assertEquals("https://www.tools.cn/#abc", buildUrl);
	}
	...
	public void testChineseFragment() {
		...
		Assert.assertEquals("https://www.tools.cn/#%E6%B5%8B%E8%AF%95", buildUrl);
	}
	...
	public void testChineseFragmentWithPath() {
		String buildUrl = new UrlBuilder()
				...
				.addPath("/s")
				.setFragment("测试").build();
		Assert.assertEquals("https://www.tools.cn/s#%E6%B5%8B%E8%AF%95", buildUrl);
	}
	...
	public void testChineseFragmentWithPathAndQuery() {
		String buildUrl = new UrlBuilder()
				...
				.addQuery("wd", "test")
				.setFragment("测试").build();
		Assert.assertEquals("https://www.tools.cn/s?wd=test#%E6%B5%8B%E8%AF%95", buildUrl);
	}

	@Test
	public void ofTest() {
		final UrlBuilder builder = UrlBuilder.of("http://www.tools.cn/aaa/bbb/?a=1&b=2#frag1", CharsetUtil.CHARSET_UTF_8);
		Assert.assertEquals("http", builder.getScheme());
		Assert.assertEquals("www.tools.cn", builder.getHost());
	...
	public void ofWithChineseTest() {
		final UrlBuilder builder = UrlBuilder.ofHttp("www.tools.cn/aaa/bbb/?a=张三&b=%e6%9d%8e%e5%9b%9b#frag1", CharsetUtil.CHARSET_UTF_8);
		Assert.assertEquals("http", builder.getScheme());
		Assert.assertEquals("www.tools.cn", builder.getHost());
	...
	public void ofSpecialTest() {
		...
		final UrlBuilder builder = UrlBuilder.ofHttp(" www.tools.cn/aaa/bbb/?a=张三&b=%%e5%9b%9b#frag1", CharsetUtil.CHARSET_UTF_8);
		Assert.assertEquals("http", builder.getScheme());
		Assert.assertEquals("www.tools.cn", builder.getHost());
