...
import com.tools.core.io.file.LineSeparator;
...
public class FileUtilTest {
	...
	public void delTest() {
		// 删除一个不存在的文件，应返回true
		boolean result = FileUtil.del("e:/tools_test_3434543533409843.txt");
	...
	public void delTest2() {
		// 删除一个不存在的文件，应返回true
		boolean result = FileUtil.del(Paths.get("e:/tools_test_3434543533409843.txt"));
		Assert.assertTrue(result);
	}
	...
	public void copyTest() {
		File srcFile = FileUtil.file("tools.jpg");
		File destFile = FileUtil.file("tools.copy.jpg");
	...
	public void equlasTest() {
		// 源文件和目标文件都不存在
		File srcFile = FileUtil.file("d:/tools.jpg");
		File destFile = FileUtil.file("d:/tools.jpg");

		boolean equals = FileUtil.equals(srcFile, destFile);
		Assert.assertTrue(equals);

		// 源文件存在，目标文件不存在
		File srcFile1 = FileUtil.file("tools.jpg");
		File destFile1 = FileUtil.file("d:/tools.jpg");
	...
	public void listFileNamesTest() {
		...
		Assert.assertTrue(names.contains("tools.jpg"));
	...
	public void listFileNamesInJarTest() {
		List<String> names = FileUtil.listFileNames("d:/test/tools-core-5.1.0.jar!/cn/tools/core/util ");
	...
	public void getWebRootTest() {
		...
		Assert.assertEquals("tools-core", webRoot.getName());
	}
